...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <div class="toc_intro">
      <p>Learning Maven can be a daunting and frustrating task.
        ...
        Maven: an example-driven introduction to Maven, <a
          ...
          by Example"
        </a> and this reference book. If you are new to
        Maven, you are encouraged to read <a
            href="http://www.sonatype.com/books/mvnex-book/reference/public-book.html">"Maven
          by Example"
        </a> as it will guide you through the first steps
        you'll take with Maven.
      </p>
    </div>
    <div class="{name(.)}">
      <h2>Authors</h2>
  ...
  <xsl:template name="header.navigation">
    ...
    <xsl:if test="$suppress.navigation = number('0') and $suppress.footer.navigation = '0'">
      <xsl:if test="$row1 or $row2">

        <xsl:if test="$row1">
          <div id="nav-sub-block">
            <a class="hide" name="nav-sub-a"></a>
            <ul id="nav-sub">
